...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top,#eef4ff_0%,#ffffff_45%,#f4fbff_100%)] dark:bg-[radial-gradient(circle_at_top,#0a1230_0%,#050914_55%,#03060b_100%)]">
      ...
      <div className="pointer-events-none absolute right-0 -bottom-24 h-80 w-80 rounded-full bg-[radial-gradient(circle,#b6f0ff_0%,#e8fbff_55%,transparent_70%)] opacity-60 blur-2xl" />
        ...
        <div className="grid w-full grid-cols-1 gap-8 md:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="rounded-3xl border border-border bg-card/70 p-8 shadow-2xl backdrop-blur-sm">
            ...
            <div className="mt-8 space-y-4">
              ...
              {error && (
                <p className="rounded-xl border border-red-500/20 bg-red-500/5 px-4 py-3 text-center text-sm text-red-500">
                  {error}
                </p>
              )}
            </div>
            ...
            <div className="mt-8 rounded-2xl border border-border bg-muted/30 p-4 text-xs text-muted-foreground">
              Secure sessions powered by Supabase Auth. Your data is encrypted
